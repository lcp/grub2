                                     ...
                                     const TPMU_SIGNATURE *p)
{
  switch (sigAlg)
    {
    case TPM_ALG_RSASSA:
      grub_Tss2_MU_TPMS_SIGNATURE_RSA_Marshal (buffer, (TPMS_SIGNATURE_RSA *)&p->rsassa);
      break;
    case TPM_ALG_RSAPSS:
      grub_Tss2_MU_TPMS_SIGNATURE_RSA_Marshal (buffer, (TPMS_SIGNATURE_RSA *)&p->rsapss);
      break;
    case TPM_ALG_ECDSA:
      grub_Tss2_MU_TPMS_SIGNATURE_ECC_Marshal (buffer, (TPMS_SIGNATURE_ECC *)&p->ecdsa);
      break;
    case TPM_ALG_ECDAA:
      grub_Tss2_MU_TPMS_SIGNATURE_ECC_Marshal (buffer, (TPMS_SIGNATURE_ECC *)&p->ecdaa);
      break;
    case TPM_ALG_SM2:
      grub_Tss2_MU_TPMS_SIGNATURE_ECC_Marshal (buffer, (TPMS_SIGNATURE_ECC *)&p->sm2);
      break;
    case TPM_ALG_ECSCHNORR:
      grub_Tss2_MU_TPMS_SIGNATURE_ECC_Marshal (buffer, (TPMS_SIGNATURE_ECC *)&p->ecschnorr);
      break;
    case TPM_ALG_HMAC:
...
#define TPM2B_BUFFER_UNMARSHAL(buffer, type, data) \
  __Tss2_MU_TPM2B_BUFFER_Unmarshal(buffer, (TPM2B *)data, sizeof(type) - sizeof(grub_uint16_t))
                                       ...
                                       TPMU_SIGNATURE *p)
{
  switch (sigAlg)
    {
    case TPM_ALG_RSASSA:
      grub_Tss2_MU_TPMS_SIGNATURE_RSA_Unmarshal (buffer, (TPMS_SIGNATURE_RSA *)&p->rsassa);
      break;
    case TPM_ALG_RSAPSS:
      grub_Tss2_MU_TPMS_SIGNATURE_RSA_Unmarshal (buffer, (TPMS_SIGNATURE_RSA *)&p->rsapss);
      break;
    case TPM_ALG_ECDSA:
      grub_Tss2_MU_TPMS_SIGNATURE_ECC_Unmarshal (buffer, (TPMS_SIGNATURE_ECC *)&p->ecdsa);
      break;
    case TPM_ALG_ECDAA:
      grub_Tss2_MU_TPMS_SIGNATURE_ECC_Unmarshal (buffer, (TPMS_SIGNATURE_ECC *)&p->ecdaa);
      break;
    case TPM_ALG_SM2:
      grub_Tss2_MU_TPMS_SIGNATURE_ECC_Unmarshal (buffer, (TPMS_SIGNATURE_ECC *)&p->sm2);
      break;
    case TPM_ALG_ECSCHNORR:
      grub_Tss2_MU_TPMS_SIGNATURE_ECC_Unmarshal (buffer, (TPMS_SIGNATURE_ECC *)&p->ecschnorr);
      break;
    case TPM_ALG_HMAC:
